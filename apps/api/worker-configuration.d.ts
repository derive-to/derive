/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9da954e4d831bfa73cafc98bf7a2b4ac)
// Runtime types generated with workerd@1.20260611.1 2024-11-01 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	...
	DERIVE_HOSTED_RUNS_ALLOWLIST: "ws_fas46hoo39z55zqg,ws_5b0iz1wp99ksykr7,ws_abfxtkvjfijoyeau";
	DERIVE_MANAGED_RUNS_ALLOWLIST: "ws_5b0iz1wp99ksykr7";
	DERIVE_ORTAM_RUNNER_PATH: "/home/ortam/derive-runtime/0.7.0/node_modules/@derive-to/cli/bin/derive.js";
	...
	ROOMS: DurableObjectNamespace<import("./src/worker").ArtifactRoom>;
	WEBHOOK_OUTBOX: DurableObjectNamespace<import("./src/worker").WebhookOutbox>;
	PREVIEW_RENDERER: DurableObjectNamespace<import("./src/worker").PreviewRenderer>;
	RUN_CONTAINER: DurableObjectNamespace<import("./src/worker").RunContainer>;
	SITE: Fetcher /* derive-site */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ArtifactRoom" | "WebhookOutbox" | "PreviewRenderer" | "RunContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DERIVE_LOOP_RUNS" | "DERIVE_SUPERADMIN_EMAILS" | "DERIVE_SIGNUP_MODE" | "DERIVE_HOSTED_RUNS_ALLOWLIST" | "DERIVE_MANAGED_RUNS_ALLOWLIST" | "DERIVE_ORTAM_RUNNER_PATH" | "BASE_URL" | "EMAIL_FROM" | "DERIVE_SANDBOX_URL" | "DERIVE_SUBDOMAIN_BASE">> {}
}
