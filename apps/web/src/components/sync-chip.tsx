...
export function SyncChip({ collapsed }: { collapsed: boolean }) {
  ...
  if (collapsed) {
    return (
      <Link
        ...
        className="flex items-center justify-center rounded-md py-2.5 text-primary hover:bg-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
      >
  ...
  return (
    <Link
      ...
      data-testid="sync-chip"
      title={`${label} · ${detail}`}
      className="flex flex-col gap-1.5 rounded-lg border border-primary/30 bg-primary/5 px-2.5 py-2 hover:bg-primary/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
    >
