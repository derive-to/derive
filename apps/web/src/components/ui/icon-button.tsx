...
// A square, icon-only button. `ghost` is the bare action (chrome, toolbars);
// `chip` is the bordered overlay (card corners). forwardRef so it can be a Radix
// trigger via asChild. Callers pass an <Icon/> child and an aria-label.
