...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        // Rest = quiet well (bg-secondary + hairline); checked = ink fill, primary-foreground dot.
    ...
    >
      ...
      >
        {/* primary-foreground dot on the ink fill — the paired-token contrast, never a bare white. */}
