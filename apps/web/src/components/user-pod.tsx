...
// The account + workspace pod that lives at the foot of the nav rail (bottom-left).
// Opens UPWARD. Holds the workspace switcher (multi mode), the segmented theme
// control, and the account actions — consolidating what used to be the top-right
// user menu plus the sidebar workspace switcher. Keeps the e2e test-ids:
// user-menu-trigger, theme-option-*, menu-settings, menu-signout, workspace-*.
