    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem
            data-testid="library-new-template"
            onSelect={() => nav({ to: "/templates" })}
          >
            <Icon name="templates" size={16} /> From a template
          </DropdownMenuItem>
          <DropdownMenuItem data-testid="library-new-write" onSelect={() => nav({ to: "/new" })}>
            <Icon name="edit" size={16} /> Blank artifact
          </DropdownMenuItem>
          <DropdownMenuItem
            data-testid="library-new-from-existing"
            onSelect={() => nav({ to: "/templates", search: { derive: true } })}
          >
            <Icon name="derive" size={16} /> From an artifact
          </DropdownMenuItem>
