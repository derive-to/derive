...
export const BUILDER_COPY = {
  ...
  arxivDoor: "Import a paper from arXiv",
  arxivTitle: "Read a paper as a Context",
  arxivBody:
    "Paste an arXiv link or id. Derive fetches the LaTeX source and BibTeX, publishes the paper locked, and wraps it in a Context your agents can read and cite.",
