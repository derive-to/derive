...
// A single comment: author, body (markdown / inline edit), reactions, and the
// hover toolbar (react / edit / copy-link / delete). Rendered both compact (the
// thread head) and expanded (every reply in an active card).
