...
export const workflowRunInstruction = ({
  ...
  return [
    ...
    `Inspect the ledger during the run with use({workflow_run:{action:"inspect", run_id:"${runId}"}}). Confirm valid suggestions with their prepared use payload after you fill any missing node or attempt.`,
