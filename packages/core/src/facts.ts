// Facts live in their OWN package (@derive/data-facts): the parser and the shapes are
// host-agnostic and dependency-free by design, so they can be read and implemented by
// anyone, not only by this server. See packages/data-facts/SPEC.md for the contract.
//
// This file is a RE-EXPORT, not a copy. Every consumer in the repo reaches facts through
