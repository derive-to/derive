...
// Coverage report (not a gate — see apps/api/vitest.config.ts) for the data layer.
// It scopes to the code this package's own tests exercise: the cross-dialect query layer (repos.ts), the SQLite driver (sqlite.ts),
